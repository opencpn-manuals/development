...
==== wxWidgets with Visual Studio 2019/2017

Getting Visual Studion setup to use wxWidgets can sometimes be difficult. Here is a video which makes the setup process clearer using Visual Studio Interface.
