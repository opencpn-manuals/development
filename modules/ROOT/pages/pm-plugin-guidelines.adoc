...
plugin xref:AlternativeWorkflow::Catalog.adoc[catalog] or on OpenCPN.org
...
xref:AlternativeWorkflow::Catalog.adoc[the catalog documenation].

== Documentation

Plugins should properly documented as described in the
xref:pm-plugin-documentation.adoc[documentation page].
