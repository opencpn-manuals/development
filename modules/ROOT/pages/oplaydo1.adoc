...
The xref:oplaydo1.adoc#_using_gimp_to_make_new_icons[icon is changed].
* In
xref:oplaydo1.adoc#_part_2_edit_the_plugin_for_new_user_actions[Part 2]
...
https://strawberryperl.com/[Strawberry Perl]
