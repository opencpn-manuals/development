...
* https://opencpn-manuals.github.io/plugins/opencpn-plugins-manual/0.1/index.html[User Plugin Manual]
* https://opencpn-manuals.github.io/development/ocpn-dev-manual/5.3.1/AboutThisManual.html[Development manual]
*
