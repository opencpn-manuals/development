...
- In
xref:oplaydo1#_part_2_edit_the_plugin_for_new_user_actions[Part 2]
...
- Using  https://shutter-project.org/downloads/third-party-packages/[Shutter]
  a screenshot was made from the 'DR_pi' icons as a starting point for the
  new icons.
